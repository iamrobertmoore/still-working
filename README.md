...
<!-- measurement:start -->
**162 days. 24 supplier-change records across 23 calendar days. 58 individual changes. 11 potentially breaking changes.**
...
Two interruptions in 5 months of replay, from 58 supplier changes. That is **3.4%**. **That ratio is the product.** [Method and scope](#evidence-and-scope).

_Window 2026-04-07 to 2026-09-16. Regenerated by the scheduled job on every run, never typed by hand. Re-run it with `python tools/impact.py --measure`._
<!-- measurement:end -->
