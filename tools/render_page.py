...
def masthead(home="./"):
    return ('<header class="masthead"><a class="brand" href="' + home +
            '" aria-label="Still Working home">' + mark() +
            '<span>still working<span class="brand-dot">.</span></span></a></header>')
...
def main() -> int:
    ...
    parts.append('<section class="story-section" aria-labelledby="story-title"><div class="story-heading"><div><p class="eyebrow">A little judgement goes a long way</p><h2 id="story-title">The change is technical.<br>The next step shouldn’t be.</h2></div><p>From the supplier’s small print to the one thing you need to know.</p></div>'
                 ...
                 '<div class="built-strip"><span>Strands Agents</span><span>Amazon Bedrock AgentCore</span><a href="architecture.svg">Explore the architecture ↗</a></div></section>')
